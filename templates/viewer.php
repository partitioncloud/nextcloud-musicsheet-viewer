...
></script>
  ...
  <body>
    <score-display src="<?php p($_GET["file"])?>" type="mscz">
      <score-track src="<?php p($_GET["file"])?>" type="mscz/synth:all">Tutti</score-track>
      <score-download href="<?php p($_GET["file"])?>">Download</score-download>
    </score-display>
  </body>
</html>
